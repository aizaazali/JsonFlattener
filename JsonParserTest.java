...
public class JsonParserTest {
	...
	/**
	 * This test verifies that the json is correctly flattened for the given input and stored in map as key-value pairs
	 */
	@Test
	...
	/**
	 * This test verifies that the flattenJson handles unsupported inputs like arrays
	 */
	@Test
	...
	/**
	 * This test verifies that the key-value pairs are populated correctly in the map
	 */
	@Test
	...
	/**
	 * This test verifies that the key-value pairs are populated correctly with a given key prefix
	 */
	@Test
	...
	/**
	 * This test verifies that the json is parsed correctly from the key-value pairs of the map
	 */
	@Test
